CREATE TABLE IF NOT EXISTS `bot_message_reaction` (
  ...
  FOREIGN KEY (`actor_chat_id`) REFERENCES `bot_chat` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `bot_message_reaction_count` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
...
CREATE TABLE IF NOT EXISTS `bot_chat_boost_updated` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
...
CREATE TABLE IF NOT EXISTS `bot_chat_boost_removed` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
  `chat_id` bigint COMMENT 'Chat which was boosted',
...
ALTER TABLE `bot_telegram_update` ADD COLUMN `chat_boost_updated_id` BIGINT UNSIGNED NULL COMMENT 'A chat boost was added or changed.';
ALTER TABLE `bot_telegram_update` ADD FOREIGN KEY (`chat_boost_updated_id`) REFERENCES `bot_chat_boost_updated` (`id`);

ALTER TABLE `bot_telegram_update` ADD COLUMN `chat_boost_removed_id` BIGINT UNSIGNED NULL COMMENT 'A boost was removed from a chat.';
ALTER TABLE `bot_telegram_update` ADD FOREIGN KEY (`chat_boost_removed_id`) REFERENCES `bot_chat_boost_removed` (`id`);
